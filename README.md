...
```
include:
  - remote: https://raw.githubusercontent.com/chesapeaketechnology/gitlab-templates/hotfix/test-coverage-visualization/lib/gitlab/ci/templates/pipeline/GradlePluginReleasePipeline.yml
```
