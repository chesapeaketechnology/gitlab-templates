...
| EMULATOR_IP                              | &check;      |                                                                                                                            | IP address of emulator for instrumentation tests. Recommend to mask the IP as a Gitlab CI/CD variable.                                                   |
| EMULATOR_ADB_PORT                        | &check;      | 5555                                                                                                                       | ADB port of emulator for instrumentation tests.                                                                                                          |
| APP_TEST_PACKAGE_NAME_TO_FORCE_UNINSTALL |              |                                                                                                                            | Name of your app's test package in case to force uninstall before running instrumentation tests.                                                         |
