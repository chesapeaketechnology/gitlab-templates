...
```
include:
  - remote: https://github.com/chesapeaketechnology/gitlab-templates/tree/bugfix/Issue-22-fix-broken-quality-report-linkslib/gitlab/ci/templates/pipeline/GradlePluginReleasePipeline.yml
```
