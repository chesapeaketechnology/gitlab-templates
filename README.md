...
| DEPLOY_DEBUG_APK_PATH                | &check;      | `app/build/outputs/apk`                                                                                                    | The directory path to the debug APK.                                                                                                                     |
| DEPLOY_DEBUG_APK_NAMES               | &check;      | "yourdebugapkname"                                                                                                         | The names of the debug APKs.                                                                                                                             | 
...
| DEPLOY_RELEASE_APK_NAMES             | &check;      | "yourreleaseapkname"                                                                                                       | The names of the release APKs.                                                                                                                           | 
