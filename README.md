...
| INSTALLER_ARTIFACT_EXCLUDES 	        | "" 	                                                                               | Anything in the INSTALLER_ARTIFACT_PATH to exclude. For example can exclude all .exes in the INSTALLER_ARTIFACT_PATH using `$INSTALLER_ARTIFACT_PATH/**/*.exe` for scenarios like installers above the max Gitlab artifact max size.	 |
