...
| PUBLISH_RELEASE_GRADLE_FLAGS  | 	                                                                                  | Gradle flags for customizing the release publish tasks                                                                                                                                                                               |
...
| SKIP_PUBLISH_TESTS  | 	                                                                                  | False to enable tests from running inside jar publishing.                                                                                                                                                                                              |
#### Reference URL
