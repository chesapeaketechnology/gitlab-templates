...
### Fixed
- Moved jacoco2cobertura from 1.0.7 to latest since 1.0.7 was removed from Gitlab's Docker registry and is causing the visualize_test_coverage Gitlab job to fail.
